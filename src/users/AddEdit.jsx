    ...
    useEffect(() => {
        if (!isAddMode) {
            ...
            userService.getById(id).then(user => {
                const fields = ['title', 'firstname', 'lastname','phone', 'address', 'role'];
                fields.forEach(field => setValue(field, user.results[field]));
    ...
    return (
        ...
        <form onSubmit={handleSubmit(onSubmit)} onReset={reset}>
            ...
            <div className="form-group">
                ...
                {!isAddMode &&
                <Link to={`../profile/${user._id}`} >Add additional information</Link>
                }
